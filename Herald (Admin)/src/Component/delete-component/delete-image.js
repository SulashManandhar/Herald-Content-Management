...
export default class DeleteImage extends Component {
    ...
    deleteData=event=>{
        ...
        console.log(this.state.flag)
        console.log('http://localhost:5000/view-us/id='+this.state.flag)
        axios.delete('http://localhost:5000/view-us/'+this.state.flag,)
        .then(res=>{
            console.log(res);
    ...
    render() {
        return (
            ...
            <div className={style.contain}>
                <h1>Delete Image</h1>
                <hr/><br/>
                <span>Press delete button to delete a image</span>
            </div>
             <table className={style.table}>
                ...
                {this.state.data.map(item=>(
                    <tr>
                        ...
                        <td id="head">{item.description}</td> 
